...
describe("Curve Contract", function () {
    ...
    it("should evaluate the exponentiation", async function() {
        ...
        const result = toZp_12Struct(await curve.exp(value, toBigNumber(await bigNumbers.init(2, false))))
        ...
        console.log(await pointZp.getBits(toBigNumber(await bigNumbers.init(2, false))))
    })
