...
class FiniteField_2__factory extends ethers_1.ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            ...
            super(_abi, FiniteField_2__factory.linkBytecode(linkLibraryAddresses), signer);
        }
    }
...
exports.FiniteField_2__factory = FiniteField_2__factory;
FiniteField_2__factory.bytecode = _bytecode;
FiniteField_2__factory.abi = _abi;
