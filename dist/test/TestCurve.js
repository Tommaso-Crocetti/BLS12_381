...
describe("Curve Contract", function () {
    ...
    beforeEach(async function () {
        const bigNumbersFactory = await hardhat_1.ethers.getContractFactory("BigNumbers");
        bigNumbers = await bigNumbersFactory.deploy();
        const getBitsFactory = await hardhat_1.ethers.getContractFactory("GetBits", {
            libraries: {
                BigNumbers: await bigNumbers.getAddress()
            }
        });
        getBits = await getBitsFactory.deploy();
        const bigFiniteFieldFactory = await hardhat_1.ethers.getContractFactory("BigFiniteField", {
            libraries: {
                BigNumbers: await bigNumbers.getAddress()
            }
        });
        ...
        const pointZpFactory = await hardhat_1.ethers.getContractFactory("PointZp", {
            libraries: {
        ...
        const TwelveExtensionFactory = (await hardhat_1.ethers.getContractFactory("TwelveExtension", {
            libraries: {
                BigNumbers: await bigNumbers.getAddress(),
                GetBits: await getBits.getAddress()
            }
        ...
        const pointZp_2Factory = await hardhat_1.ethers.getContractFactory("PointZp_2", {
            libraries: {
                GetBits: await getBits.getAddress()
            }
        });
        pointZp_2 = await pointZp_2Factory.deploy(quadraticExtension);
        const pointZp_12Factory = await hardhat_1.ethers.getContractFactory("PointZp_12");
        pointZp_12 = await pointZp_12Factory.deploy(twelveExtension);
        const curveFactory = await hardhat_1.ethers.getContractFactory("Curve", {
            libraries: {
                BigNumbers: await bigNumbers.getAddress(),
                GetBits: await getBits.getAddress()
            }
    ...
    it("should have g_1 in the curve", async function () {
        const g1 = toPoint_Zp_2Struct(await curve.get_g1());
        const point = toPoint_Zp_2Struct(await pointZp_2.double(g1));
        (0, chai_1.expect)(await curve.isOnCurveTwist(g1)).to.equal(true);
        (0, chai_1.expect)(await curve.isOnCurveTwist(point)).to.equal(true);
        (0, chai_1.expect)(await curve.isOnCurveTwist(toPoint_Zp_2Struct(await pointZp_2.add(g1, point)))).to.equal(true);
    });
    it("should unwist correctly", async function () {
        const g12 = toPoint_Zp_12Struct(await curve.untwist(toPoint_Zp_2Struct(await curve.get_g1())));
        const resultx = toZp_12Struct(await twelveExtension.createElement(toZp_6Struct(await sexticExtension.createElement(toZp_2Struct(await quadraticExtension.createElement(toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))), toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))))), toZp_2Struct(await quadraticExtension.createElement(toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))), toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))))), toZp_2Struct(await quadraticExtension.createElement(toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init__("0x000000000000000000000000000000000b156709a18054f8d1da6c63daf62fdb902825d2c9b0788eb515b6902bb190e01f7c7a1c5dcd0ca3dd1669e70f12f49b", false)))), toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init__("0x0000000000000000000000000000000008cac456b0f14a67abd2673cad311f89c943aafdcf703d8c00c4ab2bb0cdbf6913d076f5b5c750b40896131e4df136e3", false)))))))), toZp_6Struct(await sexticExtension.createElement(toZp_2Struct(await quadraticExtension.createElement(toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))), toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))))), toZp_2Struct(await quadraticExtension.createElement(toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))), toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))))), toZp_2Struct(await quadraticExtension.createElement(toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))), toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false))))))))));
        const resulty = toZp_12Struct(await twelveExtension.createElement(toZp_6Struct(await sexticExtension.createElement(toZp_2Struct(await quadraticExtension.createElement(toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))), toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))))), toZp_2Struct(await quadraticExtension.createElement(toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))), toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))))), toZp_2Struct(await quadraticExtension.createElement(toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))), toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))))))), toZp_6Struct(await sexticExtension.createElement(toZp_2Struct(await quadraticExtension.createElement(toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))), toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))))), toZp_2Struct(await quadraticExtension.createElement(toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init__("0x000000000000000000000000000000001676d5d8ed5244bc05492416a49e36c5eed987d702f5250afd73ffdacfa0307df80eeb7924f66015a31dadf2fc8ba635", false)))), toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init__("0x00000000000000000000000000000000099100b17ad4d6aa787f564fca7001ab40dbec2c76375163903165717e3f5f5165d421ace949bd8bc18a596cf3d37e34", false)))))), toZp_2Struct(await quadraticExtension.createElement(toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false)))), toZpStruct(await bigFiniteField.createElement(toBigNumber(await bigNumbers.init(0, false))))))))));
        const result = toPoint_Zp_12Struct(await pointZp_12.newPoint(resultx, resulty));
        console.log(await curve.isOnCurve_12(result));
        console.log(await curve.isOnCurve_12(g12));
        (0, chai_1.expect)(await pointZp_12.compare(g12, result)).to.equal(true);
    });
    /*
