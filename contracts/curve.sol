...
contract Curve {
    ...
    function Subgroup_1Check(Point_Zp_2 memory point) public view returns (bool) {
        return pZp_2.multiply(order, point).pointType == PointType.Affine;
    }

    function untwist(Point_Zp_2 memory point) public view returns (Point_Zp_12 memory) {
        ...
        return pZp_12.newPoint(PointType.Affine, tField.mul(x, tField.inverse(tField.createElement(a, sField.zero()))),
